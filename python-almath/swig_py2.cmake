## Copyright (c) 2019 Aldebaran Robotics. All rights reserved.
## Use of this source code is governed by a BSD-style license (can be found in COPYING file)

include(CMakeParseArguments)
FIND_PACKAGE(SWIG REQUIRED QUIET)
FIND_PACKAGE(Python2 COMPONENTS Development REQUIRED QUIET)
INCLUDE(${SWIG_USE_FILE})
if (${CMAKE_VERSION} VERSION_GREATER "3.13")
  cmake_policy(SET CMP0078 OLD)
endif()

#! CMake wrapper for swig / Python 2
# ================================
#!
...
function(qi_swig_wrap_python2 module_name interface_file)
  message(STATUS "Swig/python2: ${module_name}")
  ...
  SWIG_ADD_LIBRARY(${module_name} LANGUAGE python SOURCES ${interface_file} ${_srcs})
  ...
  target_link_libraries(${_swig_target} ${Python2_LIBRARIES})
  qi_use_lib(${_swig_target} ${ARG_DEPENDS})
  ...
  file(WRITE ${QI_SDK_DIR}/qi.pth
    "${QI_SDK_DIR}/${QI_SDK_LIB}/python3/site-packages${_subfolder}\n"
  )
